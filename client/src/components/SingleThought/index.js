      ...
      <div className='card-body flex-column'>
        ...
        <div className='flex-row align-center'>
          ...
          <div className='flex-row align-center ml-5'>
            <button aria-label="Like" className='flex-row align-center btn-clear cursor-pointer' onClick={() => checkIfLiked(thought._id) ? handleUnlike(thought._id) : handleLike(thought._id)}>
